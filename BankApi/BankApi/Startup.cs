...
namespace BankApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IBankFactory>(w => new BankFactory(Configuration.GetConnectionString("BankEntities")));
            services.AddAutoMapper(typeof(ServiceMapperProfile).GetTypeInfo().Assembly);
